    ...
    const renderItem = (m) => (
        ...
        >
            <div className="flex items-center gap-2 w-full pr-6">
                ...
                <span className={cn("truncate flex-1 text-left", isMav(m.nome) && "text-red-900 font-bold")}>
                    {m.nome}
                ...
                >
                    {selectedMed ? (
                        <div className="flex items-center gap-2 truncate overflow-hidden">
                            ...
                            <span className={cn("truncate", isMav(selectedMed.nome) && "text-red-900 font-bold")}>
                                {selectedMed.nome}
                                {selectedMed.unidade_medida ? ` - ${selectedMed.unidade_medida}` : ""}
                                {isMav(selectedMed.nome) && " (MAV)"}
                            </span>
                        </div>
                    ) : (
